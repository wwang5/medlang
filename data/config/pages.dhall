...
let pages : List s.PageUnion = [
    ...
    ./pages/hx/menu.dhall "hx/menu",
        ...
        ./pages/hx/peds/menu.dhall "hx/peds/menu",
        ./pages/hx/peds/dev.dhall "hx/peds/dev",
        ./pages/hx/peds/vax.dhall "hx/peds/vax",
        ./pages/hx/peds/neonate.dhall "hx/peds/neonate",
        ./pages/hx/peds/young.dhall "hx/peds/young",
        ./pages/hx/peds/old.dhall "hx/peds/old",
        ./pages/hx/peds/atopic.dhall "hx/peds/atopic",
